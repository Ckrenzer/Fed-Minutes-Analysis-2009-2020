...
# We may be interested in those words that have the greatest difference between groups (as opposed to most likely to appear) in each category. For this, We can use a log odds ratio to calculate this difference.
fed_topics %>% 
  mutate(topic = paste0("topic", topic)) %>% 
  tidyr::pivot_wider(names_from = topic, values_from = beta) %>% 
  filter(topic1 > 0.001 | topic2 > 0.001 | topic3 > 0.001 | topic4 > 0.001 | topic5 > 0.001 |topic6 > 0.001) %>% 
