...
There are two formats for the HTML file--one for the Fed Minutes before 2012 and those released on or after. Therefore, two functions are used to read in the different formats. The doucments are read in chronological order, but they are arranged after being added to the tibble if something were to happen to the order of the files in the "Fed Minutes Releases" folder from which these names were pulled.
```{r, echo = TRUE}
...
Inverse Document Frequency = (Total Number of Docs in Corpus) / (# of Docs where Term Appears)
