...
We can use these correlations to pick interesting words and find how other terms relate to them.
...
# Just as we used ggraph to visualize bigrams, we can use it to visualize the correlations and clusters of words that
# were found by the widyr package.
set.seed(2016)
# Pairs of words in Pride and Prejudice that show at least a 0.15 correlation of appearing within the same 10-line
# section:
word_cors %>% 
