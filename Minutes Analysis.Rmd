...
# The line graph
fed_sentiment %>% 
  ggplot(aes(x = doc_id, y = sentiment)) +
...
Look at that dip at the beginning of the 2020 recession! They don't call economics the dismal science for nothing... Why don't we use an index to compare the sentiment from the FOMC Minutes with the T-bills from earlier?
