...
```
We don't have to compare the words to other words, of course. Why don't we compare the Fed's use of "inflation" with the inflation rate growth, using an index?
