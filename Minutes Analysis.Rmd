...
data %>% 
  ...
  ggplot(aes(x = doc_id)) +
  geom_line(aes(y = word1), show.legend = T) +
  geom_line(aes(y = word2, show.legend = F)) +
  xlab("FOMC Meetings") +
  ylab("# of Uses in Minutes Releases") +
  ggtitle(graph_title)

}


change_over_time(unigram_unnested_documents, "inflation", "unemployment")
