...
As noted, this graph is very similar to the one from the Markov Chains section. The difference between this graph and its counterpart follows the same explanation provided moments before; n-grams 'pick up' fewer relationships between terms than do correlation coefficients. 
