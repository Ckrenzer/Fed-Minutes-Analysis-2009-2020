...
```{r bigram uses graph, echo = F, results = "show"}
...
```{r finc vs labor, echo = F, results = "show"}
...
```{r sentiment analysis, echo = TRUE, results = "show"}
...
```{r lda and common words per topic, echo = FALSE, results = "show"}
...
```{r comparing topics, echo = TRUE, results = "show"}
...
```{r topics by date, echo = TRUE, results = "show"}
