...
knitr::kable(tibble("Fed Minutes Text" = stringr::str_sub(documents$text[1], start = 8489, end = 8802)))
...
## REPEAT THE PREVIOUS TWO SECTIONS WITH NGRAMS!!! Also give the tables titles--and make them look better!
...
Talk about how we can use the tf-idf to identify important issues at moments in time at the Fed. In the unigram analysis, for example, the talf is important because of Quantitative Easing. Also, make sure you go through the timeline of the Fed and explain to the audience what this all means.
