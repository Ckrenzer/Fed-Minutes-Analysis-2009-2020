...
I will explore these texts using various text mining approaches including sentiment analysis, tf-idf, and topic modeling in order to identify trends within the FOMC's Meetings.
...
There is much overlap in the topics the model found. This is not surprising--FOMC Minutes usually have a predictable agenda they need to get through. Topic modeling using the latend Dirichlet allocation algorithm allows terms to be used more than once; since people use the same term in different contexts, the model includes the same terms in different topics.
